...
//                            }
	...
	animMaxiCK: function() {
	    ...
	    if (el.submenudirection == 'left' && ((this.status == 'hide' && this.conteneur.style.left != 'auto') || (this.status == 'show' && this.conteneur.style.left == 'auto' && !this.hidding))
	|| el.submenudirection == 'right' && ((this.status == 'hide' && this.conteneur.style.right != 'auto') || (this.status == 'show' && this.conteneur.style.right == 'auto' && !this.hidding)))
		return;

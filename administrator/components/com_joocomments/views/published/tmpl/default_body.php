...
<?php }
 foreach($this->items as $i => $item): ?>
	<tr class="row<?php echo $i % 2; ?>">
		...
		<td style="width:68%">
			<strong><?php echo JText::sprintf('COM_JOOCOMMENTS_TABLE_BODY_COMMENTATOR_ARTICLE_TITLE').': ';?> </strong><a <a style="text-decoration: underline;" target="_blank" href="../<?php echo ContentHelperRoute::getArticleRoute($item->alias ? ($item->article_id . ':' . $item->alias) : $item->article_id, $item->catid); ?>">

<?php
/**
 * @version		$Id: //depot/dev/Joomla/Joo_Comments/ver_1_0_0/com_joocomments/admin/views/settings/tmpl/default.php#12 $
...
<script type="text/javascript">
	...
	function requestArticleDetails(){
	 ...
	 document.getElementById('co').innerHTML=<?php echo '\'<strong>'.JText::_("COM_JOOCOMMENTS_VIEW_CONFIGURATION_FRONTEND_OPTIONS_ENABLE_DISABLE_COMMENTS_WAIT_TEXT").'<strong>\'';?>;
	...
	?>
			...
			switch($ar[0]){
				...
				case 'jform[frontend-comment':
					...
					$this->assign('sliderHeader','COM_JOOCOMMENTS_VIEW_CONFIGURATION_FRONTEND_OPTIONS_VOTINGS_HEADER');
					echo $this->loadTemplate('gravatar');
					$varLike=+1;
					break;
					case 'jform[captcha':
					...
					case 'jform[wmd':
					$this->assignRef('field',$field);
					$this->assignRef('particular',$varWmd);
					$this->assign('sliderHeader','COM_JOOCOMMENTS_VIEW_CONFIGURATION_FRONTEND_OPTIONS_WMD_HEADER');
					echo $this->loadTemplate('gravatar');
					$varWmd=+1;
					break;
					...
					$this->assign('sliderHeader','COM_JOOCOMMENTS_VIEW_CONFIGURATION_FRONTEND_ENABLE_DISABLE_COMMMENTS_HEADER');
